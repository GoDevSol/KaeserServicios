...
if (
    ...
    $responseEmail = sendMailFunction("../htmlTemplate/cotizacion.html", $word, "adminSupport@kaeserservicios.com", "Soporte Aplicacion Kaeser", $configuracionResult, "KAESER SERVICE - Cotizacion ");
