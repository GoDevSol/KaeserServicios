...
if (
    ...
    if ($result["success"] == true) {
        ...
        $responseEmail = sendMailFunction("../htmlTemplate/createRequestClient.html", $word, "adminSupport@kaeserservicios.com", "Soporte Aplicacion Kaeser", $data->correo, "KAESER SERVICE - Solicidud de Usuario ");
